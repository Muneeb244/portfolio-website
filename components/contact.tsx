...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      >
        <input
          className="h-14 px-4 rounded-lg borderBlack w-full dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none"
          name="senderEmail"
          type="email"
          required
          maxLength={500}
